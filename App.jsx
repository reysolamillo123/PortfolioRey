...
import django1 from './src/assets/images/project/django/d1.png';
import django2 from './src/assets/images/project/django/d2.png';
import django3 from './src/assets/images/project/django/d3.png';
import django4 from './src/assets/images/project/django/d4.png';  
import django5 from './src/assets/images/project/django/d5.png';
          ...
          <Carousel itemsPerView={3}>
            ...
            {(projectCategory === 'all' || projectCategory === 'beginner') && (projectLanguage === 'all' || projectLanguage === 'react') && (
             ...
             {(projectCategory === 'all' || projectCategory === 'intermediate') && (projectLanguage === 'all' || projectLanguage === 'django') && (
              <SpotlightCard spotlightColor="rgba(139, 0, 0, 0.3)">
                <div className="project-card" onClick={() => openModal([django1,django2,django3,django4,django5,django6,django7,django8], 'MidTerm Api Django Web', 'This is my first project using Django for API development like gmail automation and facebook authentication and then django rest framework for the api creation.')}>
                  <div className="card-image" style={{ backgroundImage:  `url(${django1})` }}></div>
                  <span className="difficulty-badge intermediate">Intermediate</span>
                  <div className="card-overlay">
                    <h3>MidTerm Api Django Web</h3>
